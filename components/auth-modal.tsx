      ...
      >
        {step === 'sign-in' ? (
          <>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 2px 8px var(--color-shadow-subtle)',
                transition: 'all 0.2s',
              }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = 'var(--color-surface-alt)'; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.background = 'var(--color-surface-raised)'; }}
            >
              {/* Google G logo */}
            ...
            <div style={{ textAlign: 'center', marginTop: 16, fontSize: 12, color: 'var(--color-text-faint)' }}>
          ...
          <>
            ...
            <div style={{ fontSize: 14, color: 'var(--color-text-subtle)', marginBottom: 24 }}>
            ...
            {error && (
              <div style={{ marginTop: 10, fontSize: 13, color: 'var(--color-danger)' }}>{error}</div>
            )}
        ...
        <button
          ...
          style={{
            ...
            color: 'var(--color-text-faint)', fontSize: 22, lineHeight: 1, padding: 4,
          }}
        >×</button>
      </div>
    </>
